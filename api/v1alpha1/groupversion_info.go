...
// Package v1alpha1 contains API Schema definitions for the unikraft v1alpha1 API group
// +kubebuilder:object:generate=true
// +groupName=unikraft.com
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "unikraft.com", Version: "v1alpha1"}

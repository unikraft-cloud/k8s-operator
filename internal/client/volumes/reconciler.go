	...
	*alpha1.Volume,
	...
	return &controller.Reconciler[
		*alpha1.Volume,
		...
		Client:         client,
		Scheme:         scheme,
		ResourceClient: volumeClient,
		NewObject:      newObject,
		GetSpec:        getSpec,
		SetStatus:      setStatus,
		Logger:         ctrl.Log.WithName("volumeReconciler"),
	}
}

func newObject() *alpha1.Volume {
	return &alpha1.Volume{}
}

func getSpec(obj *alpha1.Volume) *platform.CreateVolumeRequest {
	return &obj.Spec
}
